...
import {  SortableExpenseCardProps } from "../../lib/types";
    ...
    return (
        <Card ref={setNodeRef} style={style} className="flex flex-row items-center justify-between p-4 bg-black">
        <div className="flex items-center gap-3">
            {/* ✅ Drag Handle */}
            <GripVertical {...attributes} {...listeners} className="cursor-grab text-gray-400 hover:text-gray-300" />
            <div>
            <p className="font-semibold text-lg text-white">{expense.name}</p>
